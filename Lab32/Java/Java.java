...
public class Main {
    ...
    public static void printTask() {
        System.out.print("Данная программа находит числа в множестве.\n\n");
    }
    ...
    public static void printConsoleResult(Set<Character> y1) {
        System.out.print("\nЦифры в множестве: ");
        if (y1.isEmpty())
    ...
    public static void printFileResult(Set<Character> y1, File file) {
    ...
    public static void printResult(Set<Character> y1) {
        File file;
        int option;
        System.out.print("Вы хотите: \n");
        System.out.print("Выводить множесто через файл - 1\n");
        System.out.print("Выводить множесто через консоль - 2\n");
        option = chooseOption(2);
        if (option == 1) {
            file = getFileNormalWriting();
            printFileResult(y1, file);
        }
        else
